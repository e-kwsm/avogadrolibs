...
std::array<const char*, 119> element_symbols = {
...
std::array<const char*, 119> element_names = {
...
std::array<double, 119> element_masses = {
...
std::array<unsigned char, 119> valence_electrons = {
...
std::array<double, 119> element_VDW = {
...
std::array<double, 119> element_covalent = {
