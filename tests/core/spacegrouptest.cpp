...
TEST(SpaceGroupTest, reduceToPrimitive)
{
  ...
  auto primUC = std::make_shared<UnitCell>(primMat);
  ...
  auto convUC = std::make_shared<UnitCell>(convMat);
...
TEST(SpaceGroupTest, fillUnitCell)
{
  ...
  auto uc1 = std::make_shared<UnitCell>(mat1);
  ...
  auto uc2 = std::make_shared<UnitCell>(mat2);
  ...
  auto uc3 = std::make_shared<UnitCell>(mat3);
