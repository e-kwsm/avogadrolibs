...
TEST(OverlayQuadStrategyTest, exercise)
{
  ...
  EXPECT_DOUBLE_EQ(40, quad[0][0]);
  EXPECT_DOUBLE_EQ(301, quad[0][1]);
  EXPECT_DOUBLE_EQ(0, quad[0][2]);

  EXPECT_DOUBLE_EQ(90, quad[1][0]);
  EXPECT_DOUBLE_EQ(301, quad[1][1]);
  EXPECT_DOUBLE_EQ(0, quad[1][2]);

  EXPECT_DOUBLE_EQ(40, quad[2][0]);
  EXPECT_DOUBLE_EQ(240, quad[2][1]);
  EXPECT_DOUBLE_EQ(0, quad[2][2]);

  EXPECT_DOUBLE_EQ(90, quad[3][0]);
  EXPECT_DOUBLE_EQ(240, quad[3][1]);
  EXPECT_DOUBLE_EQ(0, quad[3][2]);
}
